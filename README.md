...
Space ID - 6nt8ayf4mqnz
Access Token - oxuxrTk2N28u4m9GFtSSSSQOfn8UqV9wfZtYkr4zqZc

#### Install SDK

- npm install contentful

git remote add origin https://github.com/huseyinkryl/temp-contentful-app.git
git branch -M main
